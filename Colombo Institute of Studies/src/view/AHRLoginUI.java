 ...
 * @author HP
 */
public class AHRLoginUI extends javax.swing.JFrame {
    Connection con = null;
    ResultSet rs = null;
    PreparedStatement pst = null;

    /**
     * Creates new form ahrm
     */
    public AHRLoginUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Assistant HR Login");
        ...
        jLabel1.setText("Assistant HR Login");

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/cover ph1.jpg"))); // NOI18N

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/logo2.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AHRLoginUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AHRLoginUI().setVisible(true);
            }
        });
    }
